...
import com.github.binarywang.wxvehicle.bean.coupon.*;
...
public class BaseWxPayServiceImplTest {
  ...
  public void testParseRefundNotifyResult() throws Exception {
    // 请参考com.github.binarywang.wxvehicle.bean.notify.WxPayRefundNotifyResultTest里的单元测试
  }
  ...
  public void testCreateScanPayQrcodeMode1() throws Exception {
    ...
    assertTrue(qrcodeContent.startsWith("weixin://wxvehicle/bizpayurl?"));
  ...
  public void testShorturl() throws Exception {
    String longUrl = "weixin://wxvehicle/bizpayurl?sign=XXXXX&appid=XXXXX&mch_id=XXXXX&product_id=XXXXXX&time_stamp=XXXXXX&nonce_str=XXXXX";
  ...
  /**
   * @see {@link com.github.binarywang.wxvehicle.bean.notify.WxPayOrderNotifyResultTest}
   * @throws Exception
   */
  @Test
