 ...
 * </pre>
 */
public class WxVehicleException extends Exception {
  ...
  public WxVehicleException(String customErrorMsg) {
    super(customErrorMsg);
    this.customErrorMsg = customErrorMsg;
  }

  public WxVehicleException(String customErrorMsg, Throwable tr) {
    super(customErrorMsg, tr);
    this.customErrorMsg = customErrorMsg;
  }

  private WxVehicleException(Builder builder) {
  ...
  public static WxVehicleException from(BaseWxVehicleResult payBaseResult) {
    return WxVehicleException.newBuilder()
  ...
  public static final class Builder {
    ...
    public WxVehicleException build() {
      return new WxVehicleException(this);
    }
