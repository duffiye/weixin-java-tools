package com.github.binarywang.profitsharing.bean.notify;

import com.github.binarywang.profitsharing.bean.result.BaseWxVehicleResult;
import com.github.binarywang.profitsharing.converter.WxVehicleOrderNotifyResultConverter;
...
@NoArgsConstructor
@XStreamAlias("xml")
public class WxVehicleOrderNotifyResult extends BaseWxVehicleResult {
  ...
  private List<WxVehicleOrderNotifyCoupon> couponList;
  ...
  public static WxVehicleOrderNotifyResult fromXML(String xmlString) {
    XStream xstream = XStreamInitializer.getInstance();
    xstream.processAnnotations(WxVehicleOrderNotifyResult.class);
    xstream.registerConverter(new WxVehicleOrderNotifyResultConverter(xstream.getMapper(), xstream.getReflectionProvider()));
    WxVehicleOrderNotifyResult result = (WxVehicleOrderNotifyResult) xstream.fromXML(xmlString);
  ...
  public Map<String, String> toMap() {
    ...
    if (this.getCouponCount() != null && this.getCouponCount() > 0) {
      for (int i = 0; i < this.getCouponCount(); i++) {
        WxVehicleOrderNotifyCoupon coupon = couponList.get(i);
