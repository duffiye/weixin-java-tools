...
public class SignUtils {
  ...
  public static Map<String, String> xmlBean2Map(Object bean) {
    ...
    if(bean.getClass().getSuperclass().getSuperclass() == BaseWxProfitSharingRequest.class){
      fields.addAll(Arrays.asList(BaseWxProfitSharingRequest.class.getDeclaredFields()));
    }

    if(bean.getClass().getSuperclass().getSuperclass() == BaseWxProfitSharingResult.class){
      fields.addAll(Arrays.asList(BaseWxProfitSharingResult.class.getDeclaredFields()));
    }
