 ...
 * </pre>
 */
public class WxProfitSharingException extends Exception {
  ...
  public WxProfitSharingException(String customErrorMsg) {
    super(customErrorMsg);
    this.customErrorMsg = customErrorMsg;
  }

  public WxProfitSharingException(String customErrorMsg, Throwable tr) {
    super(customErrorMsg, tr);
    this.customErrorMsg = customErrorMsg;
  }

  private WxProfitSharingException(Builder builder) {
  ...
  public static WxProfitSharingException from(BaseWxProfitSharingResult payBaseResult) {
    return WxProfitSharingException.newBuilder()
  ...
  public static final class Builder {
    ...
    public WxProfitSharingException build() {
      return new WxProfitSharingException(this);
    }
